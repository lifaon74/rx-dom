...
import { generateReactiveDOMJSLinesForRXInjectContent } from './generate-reactive-dom-js-lines-for-rx-inject-content';
...
export function transpileReactiveHTMLRXInjectContentToReactiveDOMJSLines(
  ...
  if (name === TAG_NAME) {
    ...
    return generateReactiveDOMJSLinesForRXInjectContent(template);
  } else {
    return null;
  }
}
