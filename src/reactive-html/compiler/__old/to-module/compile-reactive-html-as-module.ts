...
// import { ITerserMinifyResult, minifyJS } from '../misc/minify-js';
// import { linesToString } from '../to-lines/helpers/lines-formating-helpers';
// // import { compileHTMLAsHTMLTemplateModule } from '../to-lines/html/compile-html-as-html-template-module.ts.bcp';
...
// ): Promise<string> {
//   return minifyJS(linesToString(compileHTMLAsHTMLTemplateModule(html, generateConstantsToImportForComponentTemplateFromObject(constantsToImport))), DEFAULT_MINIFY_OPTIONS)
...
//   return minifyJS(code, DEFAULT_MINIFY_OPTIONS)
//     .then((result: ITerserMinifyResult) => {
